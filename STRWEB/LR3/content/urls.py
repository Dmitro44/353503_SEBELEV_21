...
urlpatterns = [
    path("api/contacts/", views.ContactListViewAPI.as_view(), name="contact-list-api"),
    ...
    path("api-demo/", views.ApiDemoView.as_view(), name="api_demo"),
    path("chart-demo/", views.ChartDemoView.as_view(), name="chart_demo"),
]
