document.addEventListener('DOMContentLoaded', () => {
    ...
    // Готовый список тестовых данных
    const initialEmployeesData = [
        { fullName: 'Иванов И. И.', gender: 'Мужской', maritalStatus: 'В браке' },
        { fullName: 'Петрова П. П.', gender: 'Женский', maritalStatus: 'Не в браке' },
        { fullName: 'Сидоров С. С.', gender: 'Мужской', maritalStatus: 'Не в браке' },
        { fullName: 'Кузнецова К. К.', gender: 'Женский', maritalStatus: 'В браке' },
        { fullName: 'Васильев В. В.', gender: 'Мужской', maritalStatus: 'В браке' },
        { fullName: 'Михайлова М. М.', gender: 'Женский', maritalStatus: 'Не в браке' },
    ];

    // Общая функция для расчета результата
    ...
    // --- ВАРИАНТ 1: ПРОТОТИПНОЕ НАСЛЕДОВАНИЕ ---
    {
        ...
        Object.defineProperty(Employee.prototype, 'maritalStatus', {
            ...
            set: function (value) { this._maritalStatus = value; }
        });
        ...
        const protoManager = {
            ...
            init: function() {
                this.employees = initialEmployeesData.map(d => new Employee(d.fullName, d.gender, d.maritalStatus));
    ...
    // --- ВАРИАНТ 2: КЛАССЫ ES6 ---
    {
        ...
        const classManager = {
            ...
            init: function() {
                this.employees = initialEmployeesData.map(d => new EmployeeClass(d.fullName, d.gender, d.maritalStatus));
