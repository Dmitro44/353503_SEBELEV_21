...
class Rental(models.Model):
    ...
    def save(self, *args, **kwargs):
        ...
        if not self.expected_return_date:
            self.expected_return_date = timezone.now() + timezone.timedelta(days=self.rental_days)
...
class RentalPenalty(models.Model):
    ...
    date_applied = models.DateField(default=timezone.now, verbose_name='Дата применения')
